# Notion Proxy API MCP Server

This MCP (Model Content Protocol) server provides access to Notion Proxy API API functionality through HTTP, HTTPS, and STDIO transport modes.
